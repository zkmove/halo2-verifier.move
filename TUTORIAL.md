...
```shell
cargo run --release -- --param-path params/kzg_bn254_18.srs --verifier-address 7b613c28a60c691c8ee874a0310fd0dc14e0706b406dab38a6f82493a187a256 build-publish-vk-aptos-txn --example zk-email
```
