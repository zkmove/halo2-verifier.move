...
module verifier_api::verifier_api_test {
    ...
    use verifier_api::fast_verifier;
    ...
    public fun check_verify_with_native_verifier_ok() {
        ...
        param_store::publish_serialized_params(&signer, serialized_params);
        fast_verifier::publish_serialized_vk(&signer, vk_bytes);
        fast_verifier::publish_serialized_circuit(&signer, circuit_info_bytes);

        fast_verifier::verify(
            addr, // param_address
            addr, // vk_address
            public_inputs_bytes,
            proof,
