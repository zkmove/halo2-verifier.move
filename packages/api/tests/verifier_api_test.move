...
module verifier_api::verifier_api_test {
    ...
    public fun check_verify_ok(s: &signer) {
        ...
        verifier_api::publish_protocol(&signer, vector[
    ...
    public fun check_verify_shuffle_api_ok(s: &signer) {
        ...
        verifier_api::publish_protocol(&signer,
            vector[
    ...
    public fun check_verify_with_native_verifier_ok() {
        ...
        verifier_api::param_store::publish_serialized_params(&signer, serialized_params);
        verifier_api::vk_store::publish_serialized_vk(&signer, vk_bytes);
        verifier_api::vk_store::publish_serialized_circuit(&signer, circuit_info_bytes);

        verifier_api::verifier_api::verify_with_native_verifier(
            addr, // param_address
            addr, // vk_address
            public_inputs_bytes,
            proof,
